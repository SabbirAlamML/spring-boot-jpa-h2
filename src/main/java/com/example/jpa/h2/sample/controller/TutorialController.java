package com.example.jpa.h2.sample.controller;

import com.example.jpa.h2.sample.model.Tutorial;
import com.example.jpa.h2.sample.repository.TutorialRepository;
...
public class TutorialController {
  ...
  public ResponseEntity<List<Tutorial>> getAllTutorials(
    ...
    try {
      ...
      else tutorialRepository.findByTitle(title).forEach(tutorials::add);
